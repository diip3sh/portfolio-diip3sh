...
export function GithubBento({ className }: { className?: string }) {
      ...
      <div className="group flex flex-col gap-4">
        ...
        <div className="overflow-hidden">
          {isLoading ? (
            ...
            <div className="relative h-[6rem] overflow-hidden md:h-[6.85rem] lg:h-[6.15rem]">
              <motion.div
                className="flex"
                initial={{ x: 0 }}
              ...
              >
                {[0, 1].map((loopIndex) => (
                  <div
                    ...
                    className="ml-[-4px] min-w-[600px] flex-shrink-0 grayscale group-hover:grayscale-0"
                  >
                    <HeatMap
                      value={contributions}
                      width={HEATMAP_WIDTH}
